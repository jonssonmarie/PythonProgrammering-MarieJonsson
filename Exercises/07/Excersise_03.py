...
"""
Enkelt gjort med en fast antal dagar per månad, det går att utöka
"""
...
while True:
    try:
        ...
        if current_transport_cost <= 0:
            ...
            diff_for_ticket = current_transport_cost - (cost_ticket * day_per_month)
...
if diff_for_ticket and diff_for_card > 0.0:
    print()
    print(f" Du kommer att spara {diff_for_ticket} kronor vid köp av enkelbiljett")
